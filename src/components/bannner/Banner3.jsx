                ...
                <SwiperSlide className="swiper-slide">
                    ...
                    <SwiperSlide className="swiper-slide">
                        <div className="banner-area6">
                            <div className="banner-wrapper staff">
                                <div className="banner-content">
                                    <h1>Staffing <span class="text_color2">Solution</span></h1>
                    ...
                    <SwiperSlide className="swiper-slide">
                        <div className="banner-wrapper">
                            <div className="banner-content">
                                <h1>HR & <span className="text_color2">Payroll</span></h1>
                                <p>Tired of managing complex payroll tasks on your own?</p>
                                <div className="banner-btn-group">
                                    <Link legacyBehavior href="/contact"><a className="primary-btn3 primary-btn4">HR & Payroll<span><svg width={13} height={13} viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M0 1H12M12 1V13M12 1L0.5 12" />
                                                </svg>
                                            </span></a></Link>
                                    <Link legacyBehavior href="/about">
