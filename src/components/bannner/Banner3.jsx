                        ...
                        <div className="banner-wrapper">
                            <div className="banner-content">
                                ...
                                <div className="banner-btn-group">
                                    <Link legacyBehavior href="/contact"><a className="primary-btn3 primary-btn4">Employer Of Record <span><svg width={13} height={13} viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M0 1H12M12 1V13M12 1L0.5 12" />
                                                </svg>
                                            </span></a></Link>
                    ...
                    <SwiperSlide className="swiper-slide">
                        <div className="banner-area4 banner-wrapper">
                            <div className="banner-content">
                                ...
                                <div className="banner-btn-group">
                                    <Link legacyBehavior href="/contact"><a className="primary-btn3 primary-btn4">Staffing Solutions <span>
                                                <svg width={13} height={13} viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M0 1H12M12 1V13M12 1L0.5 12" />
                                                </svg>
                                            </span></a></Link>
                        ...
                        <div className="banner-area6">
                            <div className="banner-wrapper">
                                <div className="banner-content">
                                    ...
                                    <div className="banner-btn-group">
                                        <Link legacyBehavior href="/contact"><a className="primary-btn3 primary-btn4">HR & Payroll <span>
                                                <svg width={13} height={13} viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M0 1H12M12 1V13M12 1L0.5 12" />
                                                </svg>
                                            </span></a></Link>
