    ...
    const fetchData = async () => {
      try {
        ...
        if (respData.status === 200 && respData.data.data.length > 0) {
          ...
          var mysections = respData.data.data.filter(section => section.section_title === `FooterSection1`);
          if (mysections) {
            setFooterSection(mysections[0]);
          }
        }
      } catch (error) {
          ...
          <div className="col-lg-4 col-sm-6 d-flex justify-content-lg-start justify-content-sm-end">
            <div className="footer-widget">
              ...
              <div className="menu-container">
                {footerSection?.description ?  <div dangerouslySetInnerHTML={{ __html: (footerSection?.description) }} /> :
