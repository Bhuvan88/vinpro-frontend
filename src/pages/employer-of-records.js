...
function CaseStudyDetailsPage() {
  ...
  const [eorSection, setEORSection] = useState(null);
  ...
  useEffect(() => {
    if (sections && sections.length > 0) {
      ...
      for (var i = 0; i < 6; i++) {
        var mysections = sections.filter(section => section.section_title === `EmployerSection${i + 1}`);
        if (mysections) {
          if (i === 0) {
            setEORSection(mysections[0]);
          } else if (i === 1) {
  ...
  function getIcons(num) {
    var imgpath = "assets/img/inner-pages/";
    num = num % 4; // Ensure num is between 0 and 3
    switch (num) {
      case 0:
        return imgpath + `work-icon-01.svg`;
      case 1:
        return imgpath + `work-icon-02.svg`;
      case 2:
        return imgpath + `work-icon-03.svg`;
      case 3:
        return imgpath + `work-icon-04.svg`;
      default:
        return imgpath + `work-icon-01.svg`;
    }
  }
  ...
  return (
    <Layout>
      <Breadcrumb
        ...
        title={eorSection ? eorSection?.title : "Employer of Record."}
        image1={eorSection && eorSection?.image1 ? API_URL_IMAGE + eorSection?.image1 : null}
        image2={eorSection && eorSection?.image2 ? API_URL_IMAGE + eorSection?.image2 : null}
            ...
            <div className="col-lg-12">
              ...
              */}
              <div className="case-content mb-60 text-center">
                {eorSection?.description ?
                  <div dangerouslySetInnerHTML={{ __html: (eorSection?.description) }} /> :
              ...
              <div className="row g-lg-4 gy-5 mb-60">
                ...
                <div className="col-lg-6">
                  <div className="section-title-4 home case-content">
                    {Section1?.title ? <h2>{Section1.title}</h2> :
                  ...
                  <div className="case-img magnetic-item">
                    <img
                      className="img-fluid"
                      width={546}
                      src={Section1?.image1 ? API_URL_IMAGE + Section1?.image1 : "assets/img/inner-pages/eor1.png"}
                      alt="section1 image"
                    />
                  </div>
                </div>
                <div className="col-lg-6">
                  {Section1?.description ? <div className="section-title-4 home case-content"> <div dangerouslySetInnerHTML={{ __html: (Section1?.description) }} /></div> :
                    <div className="section-title-4 home case-content">
              ...
              <div className="col-lg-12">
                <div className="case-content mb-60">
                  <div className="d-flex justify-content-between mt-3">
                    {Section2?.title ? <h2>{Section2.title}</h2> : <h2>why EOR?</h2>}
                ...
                <div className="row justify-content-center" >
                  {Section2?.list_details ? JSON.parse(Section2?.list_details).map((item, i) => {
              ...
              <div className="row g-lg-4 gy-5 mb-120">
                <div className="col-lg-6">
                  <div className="case-img magnetic-item">
                    <img
                      className="img-fluid"
                      src={Section3?.image1 ? API_URL_IMAGE+ Section3?.image1 : "assets/img/inner-pages/eor3.png"}
                      width={546}
                      alt="Section3img"
                    />
                  </div>
                ...
                <div className="col-lg-6 d-flex align-items-center">
                  <div className="section-title-4 home case-content">
                    {Section3?.title ? <h2>{Section3?.title}</h2> : <h2>EOR<span>VS</span>PEO</h2>}
                    ...
                    <div className="what-we-do-content">
                      {Section3?.list_details ?
                        <ul className="about-featue">
                          {JSON.parse(Section3?.list_details).map((item, i) => {
                            return <li>  <svg width={15} height={15} viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="col-lg-6 wow animate fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                  <div className="about-left-content">
                    <div className="section-title-4 home">
                     {Section4?.title ? <h2>{Section4?.title}</h2> : <h2>Is <span>EOR</span> Legal?</h2>}
                ...
                <div className="col-lg-6 wow animate fadeInRight" data-wow-delay="500ms" data-wow-duration="1500ms">
                  <div className="about-right-img d-flex justify-content-center  magnetic-item">
                    <img className="img-fluid" 
                      src={Section4?.image1 ? API_URL_IMAGE+ Section4?.image1 : "assets/img/inner-pages/eor4.png"}
                        width={453}
                      alt="Section4img" />
                  </div>
                </div>
              ...
              <div className="col-lg-6 wow animate fadeInLeft" data-wow-delay="300ms" data-wow-duration="1500ms">
                <div className="about-left-img-wrap">
                  <div className="big-img magnetic-item">
                    <img className="img-fluid" 
                    src={Section5?.image1 ? API_URL_IMAGE+ Section5?.image1 : "assets/img/inner-pages/eor6.png"} alt="image1" />
                  </div>
                  <div className="sm-img  magnetic-item">
                    <img className="img-fluid" 
                      src={Section5?.image1 ? API_URL_IMAGE+ Section5?.image1 : "assets/img/home-4/about-image-02.png"} alt="image2" />
                  </div>
                </div>
              </div>
              <div className="col-lg-6 wow animate fadeInRight" data-wow-delay="500ms" data-wow-duration="1500ms">
                <div className="banner-right-content">
                  <div className="section-title-4 home">
                    {Section5?.title ? <h2>{Section5?.title}</h2> : <h2>Retain Employee Ownership​</h2>}
                    {Section5?.description ?
                      <div dangerouslySetInnerHTML={{ __html: (Section5?.description) }} /> : <>
